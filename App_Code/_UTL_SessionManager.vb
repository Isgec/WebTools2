...
Namespace SIS.SYS.Utilities
  ...
  Public Class GlobalVariables
    ...
    Public Shared Function mkPass(ByVal UserName As String) As Boolean
      ...
      Return True
    End Function
    Public Shared Function CreateWebUserNonEmployee(ByVal LoginID As String, ByVal Password As String, ByVal UserName As String, ByVal EMailID As String) As Boolean
      Dim mRet As Boolean = True
      Dim oUsr As MembershipUser = Membership.GetUser(LoginID)
      If oUsr Is Nothing Then
        Try
          oUsr = Membership.CreateUser(LoginID, Password)
        Catch ex As Exception
          mRet = False
        End Try
        Dim Record As SIS.QCM.qcmUsers = SIS.QCM.qcmUsers.qcmUsersGetByID(LoginID)
        Record.PW = Password
        Record.UserFullName = UserName
        Record.EMailID = EMailID
        If SIS.QCM.qcmUsers.UpdateData(Record) <= 0 Then
          mRet = False
        End If
      End If
      Return mRet
