				...
				<table>
					<tr>
						...
						<td>
							...
							<AJX:MaskedEditExtender ID="MaskedEditExtenderCurrentPage" BehaviorID="meeCP" runat="server" Mask="99999" AcceptNegative="None" MaskType="Number" MessageValidatorTip="false" ErrorTooltipEnabled="false" TargetControlID="_CurrentPage" PromptCharacter="" />
						</td>
						<td class="mnu_but">
							<asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Black" Font-Size="9px" Text="#of" />
						</td>
						<td class="mnu_but">
							<asp:Label ID="_TotalPages" runat="server" Font-Bold="True" Font-Size="9px" ForeColor="Black" Width="25px" Style="text-align: right" />
						</td>
						<td>
							<asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="9px" ForeColor="Black" Text="Pages" />
						</td>
						<td class="mnu_but">
						...
						<td>
							...
							<AJX:MaskedEditExtender ID="MaskedEditExtenderPageSize" BehaviorID="meePS" runat="server" Mask="99999" AcceptNegative="None" MaskType="Number" MessageValidatorTip="false" ErrorTooltipEnabled="false" TargetControlID="_PageSize" PromptCharacter="" />
						...
						<td class="mnu_but">
							<asp:LinkButton ID="_PageSizeButton" runat="server" CausesValidation="False" CommandName="PageSize" ValidationGroup="currentpage" ForeColor="Black" Font-Bold="True" Font-Size="9px" Text="/Page">
							</asp:LinkButton>
						</td>
					</tr>
				</table>
